...
public class OtherSource {
    ...
    public OtherSource withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public OtherSource withPage(Object page) {
        this.page = page;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(OtherSource.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherSource) == false) {
            return false;
        }
        OtherSource rhs = ((OtherSource) other);
